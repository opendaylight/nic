...
public class SwitchInformation {
    ...
    private static final String SWITCH_NAME = "name";
    private static final String HTTP_IP = "http-ip";
    private static final String HTTP_PORT = "http-port";
    private static final String HTTP_USER = "http-user";
    private static final String HTTP_PASS = "http-password";
    ...
    public static Set<SwitchInformation> extractSwitchInformation(final JsonElement jsonElement) {
        ...
        try {
            final JsonObject switchInfosElement = ((JsonObject) jsonElement).get("switch-infos").getAsJsonObject();
            final JsonArray elements = (JsonArray) switchInfosElement.get("switch-info");
            ...
            while (iterator.hasNext()) {
                ...
                final Ipv4Address httpIp = Ipv4Address.getDefaultInstance(element.getAsJsonObject().get(HTTP_IP).getAsString());
