...
public class DatabaseInfo {
    ...
    private DatabaseInfo(final Integer vniId,
                         final MacAddress macAddress,
                         final Ipv4Address ipAddress,
                         final Ipv4Address activeSource) {
        this.vlanId = vniId;
        this.macAddress = macAddress.getValue();
        this.ipAddress = ipAddress.getValue();
        this.activeSource = activeSource.getValue();
        this.isMacLearned = false;
    }
    ...
    public void extractEvpnInfoToJson(final String databaseInfos) {
        if (isMacLearned(databaseInfos, macAddress)) {
    ...
    private boolean isMacLearned(final String elementStr, final String macAddress) {
        this.isMacLearned = (elementStr.contains(macAddress));
