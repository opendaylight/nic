...
public class Unit {
    ...
    private Inet inet;
    private final static int UNIT_NAME = 0;
    ...
    public void generateRPCStructure() {
        result.append("<unit>");
        result.append("<name>" + UNIT_NAME + "</name>");
    ...
    public void generateInterfaceCleanupRPCStructure() {
        result.append("<unit delete=\"delete\">");
        result.append("<name>" + UNIT_NAME + "</name>");
        result.append("</unit>");
    }

    public Set<String> getEthernetSwitchingAggregatedVlans() {
        final Set<String> result = Sets.newHashSet();
        if (ethernetSwitching != null) {
            result.addAll(ethernetSwitching.getAggregatedVlans());
        }
        return result;
    }
}
