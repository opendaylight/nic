...
public class Configuration {
    ...
    public synchronized String generateRPCStructure() {
        if (isNotNull(switchOptionsConfig) ||
                isNotNull(policyOptionsConfig) ||
                isNotNull(protocolConf) ||
                isNotNull(vlanConfig)) {
            ...
            result.append("</configuration>");
        } else if (isNotNull(physicalInterfaceConfigs)) {
            result.append("<configuration>");
    ...
    private boolean isNotNull(final ConfigurationInterface config) {
        return (config != null);
    }
    ...
    public static String generateCommitmentConfig(final String baseConfig) {
    ...
    private boolean shouldCompile(final Set<Configuration> configurations) {
        ...
        do {
            ...
            if (isNotNull(configuration.vlanConfig)) {
                result = true;
                break;
            }
