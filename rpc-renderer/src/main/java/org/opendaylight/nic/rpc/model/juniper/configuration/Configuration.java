...
public class Configuration {
    ...
    private ProtocolConf basicProtocolConfs;
    ...
    public synchronized void configureEvpnBasics() {
        if (this.basicProtocolConfs == null) {
            this.basicProtocolConfs = new ProtocolConf(result);
        }
        this.basicProtocolConfs.createEvpnBasicConfigs();
    }
    ...
    public synchronized String generateRPCStructure() {
        ...
        if (!isNull(switchOptionsConfig) ||
                ...
                !isNull(protocolConf) ||
                !isNull(vlanConfig) ||
                !isNull(basicProtocolConfs)) {
            generateStructure(basicProtocolConfs);
