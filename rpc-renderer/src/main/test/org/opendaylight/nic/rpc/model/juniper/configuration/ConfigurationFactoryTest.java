...
public class ConfigurationFactoryTest {
    ...
    public void testOrderingConfigsByDeviceDetails() {
        ...
        Map<DeviceDetails, String> commitByDeviceDetails = configurationFactory.generateCompiledCommitByDevice();
    ...
    public void testOrderingConfigsByDeviceDetailsForInterface() {
        ...
        final Map<DeviceDetails, String> commitByDeviceDetails = configurationFactory.generateCompiledCommitByDevice();
    ...
    public void testOrderingDeleteConfigsByDeviceDetails() {
        ...
        Map<DeviceDetails, String> commitDeleteByDeviceDetails = configurationFactory.generateCompiledCommitByDevice();
