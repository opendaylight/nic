...
public class TestUtils extends Assert {
    ...
    /**
     * A list declaration for actionsList.
     */
    private List<Actions> actionsList;

    /**
     * A list declaration for singleActionsList.
     */
    private List<Actions> singleActionsList;

    /**
     * A list declaration for subjectList.
     */
    private List<Subjects> subjectListOne;

    /**
     * A list declaration for multipleSubjectList.
     */
    private List<Subjects> multipleSubjectList;

    /**
     * A list declaration for nullSubjectList.
     */
    private List<Subjects> nullSubjectList;

    /**
     * A list declaration for epgList.
     */
    private List<Subjects> epgList;

    /**
     * A list declaration for allowActionsList.
     */
    private List<Actions> allowActionsList;

    /**
     * A list declaration for blockActionsList.
     */
    ...
    protected List<Subjects> createSubjects() {
        subjectListOne = new ArrayList<Subjects>();
    ...
    protected List<Actions> createSingleAction() {
        singleActionsList = new ArrayList<Actions>();
