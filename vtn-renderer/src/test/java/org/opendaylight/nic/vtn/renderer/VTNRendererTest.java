...
public class VTNRendererTest extends TestUtils{
     ...
     */
    Intent intent, negCase, negCaseOne, invaildSubject, invaildAction, invaildEpg, allowIntent,
            allowIntentOne, allowIntentUpdate, blockIntentOne, blockIntent, blockIntentUpdate,
            actionIntent, epgIntent, subjectIntent, negCaseUpdate;
    ...
    public  void setUp() {
        ...
        negCaseOne = new IntentBuilder().setSubjects(subjects).build();
        negCaseUpdate = new IntentBuilder().build();
        ...
        allowIntentUpdate = new IntentBuilder().setId(new Uuid(UUID_TWO)).setSubjects(subjects).setActions(allowAction).build();
        allowIntentOne = new IntentBuilder().setId(new Uuid(UUID_TWO)).setSubjects(subjects).setActions(blockAction).build();
        blockIntent = new IntentBuilder().setId(new Uuid(UUID_THREE)).setSubjects(subjects).setActions(blockAction).build();
        blockIntentOne = new IntentBuilder().setId(new Uuid(UUID_FOUR)).setSubjects(subjects).setActions(allowAction).build();
        blockIntentUpdate = new IntentBuilder().setId(new Uuid(UUID_FOUR)).setSubjects(subjects).setActions(blockAction).build();
    ...
    public void tearDown() {
        ...
        epgIntent = null;
        actionIntent = null;
        blockIntentUpdate = null;
        blockIntentOne = null;
        blockIntent = null;
        allowIntentOne = null;
        allowIntentUpdate = null;
        allowIntent = null;
        invaildEpg = null;
        invaildAction = null;
        invaildSubject = null;
