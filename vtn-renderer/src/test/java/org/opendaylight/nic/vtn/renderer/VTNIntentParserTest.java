...
public class VTNIntentParserTest extends TestBase
{
    ...
    public void testDeleteTenant() {
         ...
         * Here testing valid scenario if Tenant deleted then deleteTenant() must return true.
         */
        assertTrue(intentParser.deleteTenant(TENANT[0]));

        /**
         * Verifying that deletion of specified TENANT in VTN Manager.
         * Here testing invalid scenarios if Tenant not deleted then deleteTenant() must return false.
         */
        assertFalse(CUSTOM_MESSAGES[0], intentParser.deleteTenant(TENANT[1]));
        assertFalse(CUSTOM_MESSAGES[0], defaultParser.deleteTenant(TENANT[2]));
        assertFalse(CUSTOM_MESSAGES[0], defaultParser.deleteTenant(TENANT[3]));
    }
    ...
    public void testDeleteFlowCond() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[1], defaultParser.deleteFlowCond(FLOW_CONDITION_NAME[2]));
    }
    ...
    public void testCreateTenant() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[2], intentParser.createTenant(TENANT[1]));
        assertFalse(CUSTOM_MESSAGES[2], intentParser.createTenant(TENANT[2]));
        assertFalse(CUSTOM_MESSAGES[2], intentParser.createTenant(TENANT[3]));
        assertFalse(CUSTOM_MESSAGES[2], defaultParser.createTenant(TENANT[0]));
    }
    ...
    public void testDeleteFlowFilter() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[3], intentParser.deleteFlowFilter(11));
    }
    ...
    public void testIsBridgeExist() throws Exception {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[4], intentParser.isBridgeExist(BRIDGE[1], path));
        list.clear();
        list.add(null);
        assertFalse(CUSTOM_MESSAGES[4], intentParser.isBridgeExist(BRIDGE[0], path));
        assertFalse(CUSTOM_MESSAGES[4], intentParser.isBridgeExist(BRIDGE[1], path));
        list.clear();
        list.add(vBridge2);
        assertFalse(CUSTOM_MESSAGES[4], intentParser.isBridgeExist(BRIDGE[0], path));
    ...
    public void testCreateBridge() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[5], new VTNIntentParser().createBridge(null, null));
    }
    ...
    public void testCreateFlowFilter() throws Exception {
        ...
        newSize = list.size();
        assertEquals(CUSTOM_MESSAGES[6], newSize, initialSize);
    ...
    public void testIsFlowCondExist() throws Exception {
        ...
        VTNIntentParser intentParser3 = new VTNIntentParser() {
            ...
            public IVTNManager getVTNManager(String serviceName)
                    throws Exception {
                IVTNManager iVTNManager = Mockito.mock(IVTNManager.class);
                if (serviceName.equals(DEFAULT_SERVICE))
                    throw new Exception();
                return iVTNManager;
            }
        };
         ...
         */
        assertFalse(CUSTOM_MESSAGES[7], intentParser3.isFlowCondExist(FLOW_CONDITION_NAME[2]));
    }
    ...
    public void testDeleteDefault() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[8], new VTNIntentParser().deleteDefault());
    }
    ...
    public void testDelete() {
        ...
        newSize = VTNRendererUtility.hashMapIntentUtil.size();
        assertEquals(CUSTOM_MESSAGES[9], newSize, initialSize);
    ...
    public void testConstructCondName() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[10], intentParser.constructCondName(VALID_SRC_ADDRESS[0],
                INVALID_DST_ADDRESS[2]) instanceof String);
        assertFalse(CUSTOM_MESSAGES[10], intentParser.constructCondName(INVALID_SRC_ADDRESS[0],
                INVALID_SRC_ADDRESS[0]) instanceof String);
        assertFalse(CUSTOM_MESSAGES[10], intentParser.constructCondName(INVALID_SRC_ADDRESS[2],
                VALID_DST_ADDRESS[2]) instanceof String);
        assertFalse(CUSTOM_MESSAGES[10], intentParser.constructCondName(VALID_SRC_ADDRESS[2],
    ...
    public void testCreateDefault() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[11], intentParser.createDefault());
        assertFalse(CUSTOM_MESSAGES[11], intentParserobj.createDefault());
    ...
    public void testUpdateRendering() {
        ...
        newSize = intentList.size();
        newContent = intentList.toString();
        assertEquals(CUSTOM_MESSAGES[12], newSize, initialSize);
        assertEquals(CUSTOM_MESSAGES[12], initialContent, newContent);
        ...
        newSize = intentList.size();
        newContent = intentList.toString();
        assertEquals(CUSTOM_MESSAGES[12], initialSize,  newSize);
        assertEquals(CUSTOM_MESSAGES[12], initialContent, newContent);
    ...
    public void testcreateFlowCond() {
         ...
         */
        assertFalse(CUSTOM_MESSAGES[13], intentParser.createFlowCond(null, null, null));
        assertFalse(CUSTOM_MESSAGES[13], intentParser.createFlowCond(INVALID_SRC_ADDRESS[1],
                VALID_DST_ADDRESS[0], FLOW_CONDITION_NAME[2]));
        assertFalse(CUSTOM_MESSAGES[13], intentParser.createFlowCond(VALID_SRC_ADDRESS[0],
    ...
    public void testRendering() {
        ...
        newSize = intentList.size();
        newContent = intentList.toString();
        assertEquals(CUSTOM_MESSAGES[14], initialSize, newSize);
        assertEquals(CUSTOM_MESSAGES[14], initialContent, newContent);
