...
public class TestBase extends Assert {
    ...
    protected static final String[] VALID_SRC_ADDRESS = { "10.0.0.1",
            "10.0.0.50", "6e:4f:f7:27:15:c9", "10.0.0.3" };

    /**
     * List of valid source IPAddresses and MAC Addresses.
     */
    protected static final String[] VALID_DST_ADDRESS = { "10.0.0.2",
            "10.0.0.40", "4e:3f:f7:17:15:d8" };
     ...
     */
    protected static final String TENANT = "vtnRenderer";
     ...
     */
    protected static final String[] INTENT_ENTITY_DESCRIPTION={"Flow filter condition", "Flow filter condition2"};

    /**
     * List of Intent EntityNames.
     */
    protected static final String[] INTENT_ENTITY_NAMES={"FlowFilter", "Condition_123"};
