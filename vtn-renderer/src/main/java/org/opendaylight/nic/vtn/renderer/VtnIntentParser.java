...
public class VtnIntentParser {
    ...
    /**
     * Creates a default Virtual Teanent and default bridge with Vlan mapping
     */
            ...
            if ((validateIP(adressSrc))
                ...
                case "block":
                    ...
                    createFlowFilter(TENANTNAME, BRIDGENAME, "DROP",
                            condNameSrcDst, true, intentList);
                    createFlowFilter(TENANTNAME, BRIDGENAME, "DROP",
                            condNameDstSrc, false, intentList);
                    createFlowFilter(TENANTNAME, BRIDGENAME, "DROP",
                            "match_any", false, intentList);
                    break;
                default:
    ...
    public void Delete(String intentID) {
        try {
            ArrayList<IntentWrapper> list = VTNRendereUtility.hashMapIntentUtil
                    .get(intentID);
     ...
     * @param adressSrc
     * @param addressDst
     * @return flow condition name on valid IP Adress or Mac Address
     */
    ...
    public boolean createTenant(String tenantName, IVTNManager mgr) {
        ...
        try {
            ...
            if (!checkTenatStatus(tenantName)) {
     ...
     * @return
     */
    public boolean checkTenatStatus(String tenantName) {
                ...
                if (addressSrc.equalsIgnoreCase("0.0")) {
                    ...
                    if (validateIP(addressSrc)) {
                        InetMatch match = new Inet4Match(
                                ...
                                InetAddress.getByName(addressDst), null, null,
                                null);
     ...
     * 
     * @param condName
     *            returns true on sucessfull deletion
     * @return
     */
    ...
    /**
     * Delete an Existing flowfilter with received ID
     * 
     * @param index
     * @return
     */
    ...
    /**
     * Validate teh given Mac address
     * 
     * @param macAddress
