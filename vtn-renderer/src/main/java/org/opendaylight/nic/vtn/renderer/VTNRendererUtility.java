...
public class VTNRendererUtility {
     ...
     * @param isStatus Status of the intent
    ...
    public boolean addIntent(Intent intent, Status isStatus) {
        ...
        log.info("The intent status is inserted successfully: {}", intents);
        listIntents();
        return true;
    }
    ...
    private List<Intent> listIntents() {
        ...
        log.info("List of Intents retrieved successfully {}", listOfIntents);
