...
public class NemoInputBuilders {
    ...
    public static StructureStyleNemoUpdateInputBuilder getUpdateBuilder(final BandwidthOnDemandParameters params) {
        ...
        ConditionSegment cs1 = condition(1L, None, CONDITION_TIME, NotLessThan, params.startTime.toString(formatter));
        ConditionSegment cs2 = condition(2L, And, CONDITION_TIME, LessThan, endTime.toString(formatter));
    ...
    private static ConditionSegment condition(long order, PrecursorRelationOperator relation,
            ConditionParameterName parameterName, ConditionParameterMatchPattern matchPattern, String string) {
        return new ConditionSegmentBuilder()
                ...
                .setConditionParameterTargetValue(
                        new ConditionParameterTargetValueBuilder().setStringValue(string).build()).build();
    }
