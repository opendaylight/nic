...
public class CompilerGraphImpl implements CompilerGraph {
    ...
    protected static DirectedSparseGraph<Set<Nodes>, Set<Edges>> policyGraph = new DirectedSparseGraph<Set<Nodes>, Set<Edges>>();
    ...
    public void init() {
        ...
        IntentMappingService mappingSvc = null;
        ...
        intentMappingService = mappingSvc;
    ...
    @Override
    public DirectedSparseGraph<Set<Nodes>, Set<Edges>> compile(Collection<InputGraph> policies) throws CompilerGraphException {

        DirectedSparseGraph<Set<Nodes>, Set<Edges>> policyGraph1 = new DirectedSparseGraph<Set<Nodes>, Set<Edges>>();
