...
public class ExpressionImpl implements Expression {
    ...
    public Set<ExpressionImpl> sub(ExpressionImpl other) {
        ...
        Set<ExpressionImpl> ss = new HashSet<ExpressionImpl>();
        Set<TermType> termTypeUnion = new HashSet<TermType>(this.getTermTypes());
        termTypeUnion.addAll(other.getTermTypes());
        ...
        for (TermType tt : termTypeUnion) {
            ...
            // create expression
            Collection<TermImpl> co = new HashSet<TermImpl>();
            co.add(termDifference);
            for (TermImpl ti : getTerms()) {
                if (ti.getType() == tt) {
                    continue;
                }
                co.add(ti);
