...
public class CompilerGraphImplTest {
    CompilerGraphImpl intentCompiler;
    Edges allow;
    Edges block;
    Edges redirect;
    Edges monitor;
    ...
    private void testCompile(Collection<InputGraph> input, Collection<InputGraph> output)
            throws Exception {
        DirectedSparseGraph<Set<Nodes>, Set<Edges>> compiledPolicies = intentCompiler.compile(input);
    ...
    public void setUp() throws Exception {
        ...
        intentCompiler = new CompilerGraphImpl(intentMappingService);
