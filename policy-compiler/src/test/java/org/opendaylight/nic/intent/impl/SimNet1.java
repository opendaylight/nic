...
/**
 * Creates a simulated network based on a single vlan network, with a specific
 * set of resources.
 * <p>
 * network devices [ "access_sw1" ] endpoints[attributes] = 10.0.0.1[employee],
 * 10.0.0.2[database], 10.0.0.3[authorziedDnsServers] 10.0.0.4[ips] Test
 * 
 * @author Duane Mentze
 * 
 */
