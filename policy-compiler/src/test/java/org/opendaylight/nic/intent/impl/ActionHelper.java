...
public class ActionHelper {
    ...
    public static HashMap<ActionLabel, AuxiliaryData> allow() {
        ...
        actions.put(AllowActionType.getInstance().label(), new AuxiliaryDataImpl());
        return actions;
    }

    public static HashMap<ActionLabel, AuxiliaryData> block() {
        HashMap<ActionLabel, AuxiliaryData> actions = new HashMap<ActionLabel, AuxiliaryData>();
        actions.put(BlockActionType.getInstance().label(), new AuxiliaryDataImpl());
        return actions;
    }
    ...
    public static HashMap<ActionLabel, AuxiliaryData> audit(String pktCaptureService) {
