...
/**
 * A classifier of network traffic which determines whether a policy will apply to
 ...
 * <p>
 * An {@link Expression} has a list of unique {@link Terms}s:  [ t1, t2
 * which are logically combined with ANDs:  t1 AND t2 AND ...
 * <p>
 ...
 * <p>
 * Putting all of this together, a classifier has this implied layout:
 *    c = e1 or e2 or ...
 *    e = t1 & t2 & ...
 *    t = <name, i1 or i2 or ...>
 * <p>
 * Here is a more concrete example:
 *    t.a = IP_PROT[10,30] or [50,60]
 *    t.b = VLAN[1,5]
 *    e.1 = t.a & t.b = (IP_PROT[10,30] or [50,60]) AND (VLAN[1,5])
 *
 *    t.c = IP_PROT[1,5]
 *    t.d = VLAN[14]
 *    e.2 = t.c & t.d = IP_PROT[1,5] and VLAN[14]
 *
 *    c = e1 or e2 = (IP_PROT[10,30] or [50,60]) AND (VLAN[1,5])  OR   IP_PROT[1,5] and VLAN[14]
 *
 * @author Duane Mentze
 *
 */
public interface Classifier {
	...
	/**
	 * Returns whether or not this classifier is empty. An empty classifier
	 * is a classifier with no specified expressions.
	 *
