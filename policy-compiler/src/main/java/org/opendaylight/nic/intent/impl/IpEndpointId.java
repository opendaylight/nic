...
/**
 * A globally-unique identifier for a specific endpoint, where the identifier is
 * based upon the unique combination of IP address and network segment.
 *
...
public class IpEndpointId implements EndpointId {
    ...
    /**
     * Constructs an endpoint ID which represents the endpoint with the given IP
     * on the given network segment.
     *
     * @param ip
     *            IP address
     * @param segId
