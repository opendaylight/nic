 ...
 * endpoints on the network.Application request for setting network behavior.
 * <p>
 * Network policies are expressed as source and destination {@link EndpointGroup}s,
 * {@link Classifier} describing the traffic of interest between {@link Endpoint}s,
 * and a set of {@link Action}s to take on the traffic.
 *
 * @author Duane Mentze
 */
