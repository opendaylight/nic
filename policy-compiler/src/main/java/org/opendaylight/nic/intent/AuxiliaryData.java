...
/**
 * The common interface for all auxiliary data given to both
 * {@link ActionTranslator} objects to use during translation and the
 * {@link PolicyService} during compilation. This data accompanies and is
 * specific to an {@link ActionType}.
 *
