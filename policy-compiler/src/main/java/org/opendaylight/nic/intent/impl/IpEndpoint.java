...
public class IpEndpoint implements Endpoint {
    ...
    /**
     * Returns the IP address of this endpoint. The IP address is not
     * guaranteed to be unique, except when taken in the context of
     * a network {@link SegmentId}.
     *
     * @return IP address
     */
    ...
    /**
     * Returns the device port where this endpoint resides. Taken in
     * combination with the value returned by {@link #device()}, this
     * value identifies the location of the endpoint in the network.
     *
     * @return device port
     */
	public Port port() {
    ...
    /**
     * Returns the device where this endpoint resides. Taken in combination
     * with the value returned by {@link #port()}, this value identifies
     * the location of the endpoint in the network.
     *
     * @return device
     */
    ...
    /**
     * Returns the network segment for this endpoint. The network segment
     * may be a VLAN, VxLAN, or any other network segment identifier.
     *
	...
	public IpEndpoint(InetAddress ip, Port port, SegmentId segId, Device device) {
		...
		this.attributes.add(new EndpointAttributeImpl(this.ip.getHostAddress()));
	...
	public String toString() {
		return "IpEndpoint {ip=" + ip + ", port=" + port.value()
				+ ", device=" + device.id()  + segId + attributes + "}";
	}
