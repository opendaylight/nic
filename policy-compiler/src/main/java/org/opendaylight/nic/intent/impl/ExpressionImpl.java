...
/**
 * ExpressionImpl is used as a building block to create {@link ClassifierImpl}s.
 * It consists of a {@link Set} of {@link TermImpl}s. The TermImpl can be
 * thought of as logically AND'd together to from the ExpressionImpl.
 *
 * @author Duane Mentze
 */
