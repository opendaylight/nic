 ...
 * <p>
 * Overlaps must exist between two nodes (n1,ns2) in all dimensions. The
 * dimension include: source endpoint group, destination endpoint group and
 * classifier.
 *
 * @author Duane Mentze
 */
public class DetectResolve {
     ...
     * @return true if overlap is found, false otherwise
     */
    private boolean detectAndResolve(CompilerNode n1, CompilerNode n2,
            DetectResolveCompilerNode dcrn) {
