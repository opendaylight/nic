...
public enum TokenType {
    ...
    LEFTPAREN("^[(]$", Associativity.NONE, 0, false, false), RIGHTPAREN(
            "^[)]$", Associativity.NONE, 0, false, false),

    LABEL("^[a-zA-Z][\\w_]*(?<![aA][nN][yY])$", Associativity.NONE, 0, false,
            true) {
    ...
    /*
     * TODO ATT_IP_RANGE ipsubnet IPv4 supports the '/' CIDR notation. A regex
     * for 0-32 is [0-9]|[12][0-9]|[3][0-2] IPV6 supports the ::/ notation, for
     * 0-128
     */

    /*
     * TODO Label plus wild card ATT_LABEL_WC("^\\w+[*]{1}$",
     * Associativity.NONE, 0, false, true) { public boolean isMember(Endpoint
     * ep, Set<EndpointAttribute> attributes) { return false; } },
     */
    ...
    private TokenType(String pattern, Associativity associativity,
            int priority, boolean isOperator, boolean isAttribute) {
