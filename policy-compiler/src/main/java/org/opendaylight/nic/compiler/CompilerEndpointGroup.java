...
public class CompilerEndpointGroup extends EndpointGroupImpl {
	...
	private CompilerEndpointGroup(EndpointGroupImpl group, PrefixExpression expression) {
		super(group);
		this.expression = new PrefixExpression(expression);
	}

	private CompilerEndpointGroup(EndpointGroup group, PrefixExpression expression) {
		super(group.group());
