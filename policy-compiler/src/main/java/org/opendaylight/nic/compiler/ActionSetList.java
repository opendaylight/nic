...
/**
 * List of {@link ActionSet}s. These are typically used in combining
 * policies, to give ordering to the priority in which {@link ActionSet}s
 * should apply for a given {@link CompiledPolicy}.
 *
 * @author Duane Mentze
 *
 */
public interface ActionSetList {
	 ...
	 *
	 * @param list the given action set list
