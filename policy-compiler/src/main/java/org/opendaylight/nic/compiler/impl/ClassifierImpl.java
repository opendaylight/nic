...
public class ClassifierImpl implements Classifier {
	...
	public static ClassifierImpl getInstance(Collection<ExpressionImpl> ExpressionCollection) {
     ...
     * Subtracting or'd items in a list is done using subtraction
     * Each subtracted item can do 1 of 4 things to the 'self' items:
     * <ul>
	...
	public ClassifierImpl sub(ClassifierImpl other) {
		...
		List<ExpressionImpl> workList = new LinkedList<ExpressionImpl>(this.expressions);
