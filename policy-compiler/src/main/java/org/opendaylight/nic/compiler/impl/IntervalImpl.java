...
/**
 * An implementation of {@link Interval}.
 *
 * @author Duane Mentze
 */
...
public class IntervalImpl implements Interval, Comparable<IntervalImpl> {
	 ...
	 *
	 * @param other
	 * @return List of Intervals, since operator may result in 0
	 *         or more intervals
	 */
	 ...
	 * <p>
	 * Intervals which overlap or are adjacent are combined into single intervals.
	 * The list is sorted by the start of each Interval.
	 */
	...
	static private List<IntervalImpl> createList(IntervalImpl i1, IntervalImpl i2) {
		List<IntervalImpl> list = new ArrayList<IntervalImpl>();
		list.add(i1);
		list.add(i2);
		return list;
