...
public class DetectResolveCompilerNode {
    ...
    public DetectResolveCompilerNode(CompilerNode n1, CompilerNode n2,
    ...
    public void handle_S1andNotS2_D1andNotD2_C1(CompilerNode n1, CompilerNode n2) {
        n1.createNonOverlapNode(n2, "1&2.1", s1e.andNot(s2e), d1e.andNot(d2e),
                c1, list, endpointMap);
    }
    ...
    public void handle_S1andNotS2_D1andNotD2_C1andNotC2(CompilerNode n1,
            CompilerNode n2) {
        n1.createNonOverlapNode(n2, "1.1", s1e.andNot(s2e), d1e.andNot(d2e),
                sc.c1Subc2(), list, endpointMap);
    }
    ...
    public void handle_S1andNotS2_D1andNotD2_C1andC2(CompilerNode n1,
            CompilerNode n2) {
        n1.createNonOverlapNode(n2, "2.1", s1e.andNot(s2e), d1e.andNot(d2e),
                sc.c1Andc2(), list, endpointMap);
    }
    ...
    public void handle_S1andNotS2_D1andD2_C1(CompilerNode n1, CompilerNode n2) {
        n1.createNonOverlapNode(n2, "3&4.1", s1e.andNot(s2e), d1e.and(d2e), c1,
                list, endpointMap);
    }
    ...
    // case S1 and not S2 D1 and D2 C1 and not C2
    public void handle_S1andNotS2_D1andD2_C1andNotC2(CompilerNode n1,
            CompilerNode n2) {
        n1.createNonOverlapNode(n2, "3.1", s1e.andNot(s2e), d1e.and(d2e),
                sc.c1Subc2(), list, endpointMap);
    }
    ...
    // case S1 and not S2 D1 and D2 C1 and C2
    public void handle_S1andNotS2_D1andD2_C1andC2(CompilerNode n1,
            CompilerNode n2) {
        n1.createNonOverlapNode(n2, "4.1", s1e.andNot(s2e), d1e.and(d2e),
                sc.c1Andc2(), list, endpointMap);
    }
    ...
    public void handle_S1andS2_D1andNotD2_C1(CompilerNode n1, CompilerNode n2) {
        n1.createNonOverlapNode(n2, "5&6.1", s1e.and(s2e), d1e.andNot(d2e), c1,
                list, endpointMap);
    }
    ...
    // case S1 and S2 D1 and not D2 C1 and not C2
    public void handle_S1andS2_D1andNotD2_C1andNotC2(CompilerNode n1,
            CompilerNode n2) {
        n1.createNonOverlapNode(n2, "5.1", s1e.and(s2e), d1e.andNot(d2e),
                sc.c1Subc2(), list, endpointMap);
    }
    ...
    // case S1 and S2 D1 and not D2 C1 and C2
    public void handle_S1andS2_D1andNotD2_C1andC2(CompilerNode n1,
            CompilerNode n2) {
        n1.createNonOverlapNode(n2, "6.1", s1e.and(s2e), d1e.andNot(d2e),
                sc.c1Andc2(), list, endpointMap);
    }
    ...
    // case S1 and S2 D1 and D2 C1 and not C2
    public void handle_S1andS2_D2andD2_C1andNotC2(CompilerNode n1,
            CompilerNode n2) {
        n1.createNonOverlapNode(n2, "7.1", s1e.and(s2e), d1e.and(d2e),
                sc.c1Subc2(), list, endpointMap);
    }

    // case 2.3: S2 and not s1 D2 and not D1 C2
    public boolean test_S2andNotS2_D2_andNotD1_C2() {
        return !sc.s2Subs1().isEmpty() && !sc.d1Subd2().isEmpty()
                && !c2.isEmpty();
    }

    // case 2.3: S2 and not s1 D2 and not D1 C2
    public void handle_S2andNotS1_D2andNotD1_C2(CompilerNode n1, CompilerNode n2) {
        n2.createNonOverlapNode(n1, "1&2.2", s2e.andNot(s1e), d1e.andNot(d2e),
                c2, list, endpointMap);
    }
    ...
    // case 2.3: S2 and not s1 D2 and not D1 C2 and not C1
    public void handle_S2andNotS1_D2andNotD1_C2andNotC1(CompilerNode n1,
            CompilerNode n2) {
        n2.createNonOverlapNode(n1, "1.2", s2e.andNot(s1e), d1e.andNot(d2e),
                sc.c2Subc1(), list, endpointMap);
    }
    ...
    // case 2.3: S2 and not s1 D2 and not D1 C2 and C1
    public void handle_S2andNotS1_D2andNotD1_C2andC1(CompilerNode n1,
            CompilerNode n2) {
        n2.createNonOverlapNode(n1, "2.2", s2e.andNot(s1e), d1e.andNot(d2e),
                sc.c1Andc2(), list, endpointMap);
    }
    ...
    public void handle_S2andNotS1_D2andD1_C2(CompilerNode n1, CompilerNode n2) {
        n2.createNonOverlapNode(n1, "3&4.2", s2e.andNot(s1e), d1e.and(d2e), c2,
                list, endpointMap);
    }
    ...
    public void handle_S2andNotS1_D2andD1_C2andNotC1(CompilerNode n1,
            CompilerNode n2) {
        n2.createNonOverlapNode(n1, "3.2", s2e.andNot(s1e), d1e.and(d2e),
                sc.c2Subc1(), list, endpointMap);
    }
    ...
    // case S2 and not S1 D1 and D2 C2 and C1
    public void handle_S2andNotS1_D2andD1_C2andC1(CompilerNode n1,
            CompilerNode n2) {
        n2.createNonOverlapNode(n1, "4.2", s2e.andNot(s1e), d1e.and(d2e),
                sc.c1Andc2(), list, endpointMap);
    }
    ...
    public void handle_S2andS1_D2andNotD1_C2(CompilerNode n1, CompilerNode n2) {
        n2.createNonOverlapNode(n1, "5&6.2", s2e.and(s1e), d2e.andNot(d1e), c2,
                list, endpointMap);
    }
    ...
    // case S1 and S2 D2 and not D1 C2 and not C1
    public void handle_S2andS1_D2andNotD1_C2andNotC1(CompilerNode n1,
            CompilerNode n2) {
        n2.createNonOverlapNode(n1, "5.2", s2e.and(s1e), d2e.andNot(d1e),
                sc.c2Subc1(), list, endpointMap);
    }
    ...
    // case S1 and S2 D2 and not D1 C2 and C1
    public void handle_S2andS1_D2andNotD1_C2andC1(CompilerNode n1,
            CompilerNode n2) {
        n2.createNonOverlapNode(n1, "6.2", s2e.and(s1e), d2e.andNot(d1e),
                sc.c1Andc2(), list, endpointMap);
    }
    ...
    // case S1 and S2 D1 and D2 C2 and not C1
    public void handle_S2andS2_D2andD1_C2andNotC1(CompilerNode n1,
            CompilerNode n2) {
        n2.createNonOverlapNode(n1, "7.2", s2e.and(s1e), d1e.and(d2e),
                sc.c2Subc1(), list, endpointMap);
    }
