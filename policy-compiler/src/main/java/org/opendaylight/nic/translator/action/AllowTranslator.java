...
public class AllowTranslator extends BaseActionTranslator {

    @Override
    public Set<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Instruction> translate(AuxiliaryData none) {
        ...
        Action allow = new ActionBuilder().setAction(new OutputActionCaseBuilder()
            .setOutputAction(new OutputActionBuilder()
                .setOutputNodeConnector(new Uri(OutputPortValues.NORMAL.toString())).build()).build())
            .build();
    ...
    public ActionLabel actionLabel() {
        return AllowActionType.getInstance().label();
    }
