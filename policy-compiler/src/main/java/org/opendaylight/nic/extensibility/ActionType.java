...
/**
 * An action type which becomes the reference behind a {@link ActionLabel}.
 * The {@link ActionLabel} is the user-facing label which corresponds to
 * this internally-used type.
 * This type must be registered with the {@link PolicyFramework} prior to use.
 *
...
public interface ActionType {
    ...
    /**
     * Returns whether or not this action is allowed to have duplicates
     * when it is compiled. For instance, an action which sets a minimum
     * bandwidth should not have any duplicates because only one minimum
    ...
    /**
     * Resolves duplicate actions by choosing one to supercede the other:<ul>
     * <li> 1:  for a
     * <li>-1:  for b
     * <li> 0:  for either
     * </ul>
