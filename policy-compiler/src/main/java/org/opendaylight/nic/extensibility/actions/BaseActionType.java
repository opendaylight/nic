...
/**
 * A base @link ActionType} which may be used for creating a specific action
 * type.
 *
...
public abstract class BaseActionType implements ActionType {
     ...
     *            the action label
     * @param isObserver
     *            whether or not the action is an observer
     * @param isComposable
     *            whether or not the action is composable
     * @param allowDuplicate
     *            whether or not the action can have duplicates
     * @param precedence
     *            action precedence value
     */
    protected BaseActionType(ActionLabel label, boolean isObserver,
            boolean isComposable, boolean allowDuplicate, long precedence) {
        if (label == null)
