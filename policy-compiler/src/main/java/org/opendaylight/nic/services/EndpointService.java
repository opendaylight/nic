 ...
 * Applications may register {@link EndpointAttribute}s, apply those attributes
 * to specific endpoints, or add/remove endpoints from this datastore.
 *
...
public interface EndpointService {
     ...
     * All endpoint attributes must be registered prior to applying them to
     * specific endpoints.
     *
     * @param attribute
     *            the endpoint attribute to register
     */
     ...
     * Note that prior to use, all endpoint attributes must be registered by the
     * application intending to use them.
     *
     * @param attribute
     *            the endpoint attribute to apply
     * @param ep
     *            the endpoint to which the attribute will be applied
     */
