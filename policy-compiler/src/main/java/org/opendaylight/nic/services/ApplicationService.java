...
/**
 * Provides a mechanism for management of applications. Applications
 * register with the controller to obtain an {@link AppId} which is
 * used to uniquely identify that application in other requests.
 *
 * @author Duane Mentze
 */
