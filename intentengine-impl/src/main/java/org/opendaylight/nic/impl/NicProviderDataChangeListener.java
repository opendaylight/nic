...
public class NicProviderDataChangeListener implements DataChangeListener,
    ...
    public NicProviderDataChangeListener(DataBroker dataBroker){
		...
		intentListener = dataProvider.registerDataChangeListener(LogicalDatastoreType.OPERATIONAL, NicProvider.intentNodeId, this, DataChangeScope.SUBTREE);
    	LOG.debug("Initialized intent processor");        
    }
