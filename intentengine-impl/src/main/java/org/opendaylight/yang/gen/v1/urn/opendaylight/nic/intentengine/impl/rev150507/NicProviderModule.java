...
public class NicProviderModule
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final EndpointChangeListener endpointProvider =
                new EndpointChangeListener(getDataBrokerDependency());
        provider.init(endpointProvider);
        endpointProvider.readInitial();
        return provider;
    }
