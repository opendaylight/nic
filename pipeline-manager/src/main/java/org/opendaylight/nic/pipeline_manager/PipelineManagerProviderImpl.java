...
public class PipelineManagerProviderImpl implements DataChangeListener, PipelineManager {
    ...
    private List<TableFeatureProperties> getTableFeatureProperties(NodeId nodeId, Short tableId) {
    ...
    private List<Short> getNextTablesMiss(NodeId nodeId, Short tableId) {
