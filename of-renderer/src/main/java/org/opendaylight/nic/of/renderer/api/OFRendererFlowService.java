...
public interface OFRendererFlowService {
    ...
    String getShortestPath(String sourceNodeConnectorId, String targetNodeConnectorId);

    String getDisjointPaths(String sourceNodeConnectorId, String targetNodeConnectorId);
}
