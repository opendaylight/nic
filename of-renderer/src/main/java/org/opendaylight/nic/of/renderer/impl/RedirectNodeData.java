...
public class RedirectNodeData {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((destMacNodeId == null) ? 0 : destMacNodeId.hashCode());
        result = prime * result + ((egressNodeId == null) ? 0 : egressNodeId.hashCode());
        result = prime * result + ((ingressNodeId == null) ? 0 : ingressNodeId.hashCode());
        result = prime * result + ((srcMacNodeId == null) ? 0 : srcMacNodeId.hashCode());
    ...
    public String toString() {
        return "RedirectNodeData [srcMacNodeId=" + srcMacNodeId
                ...
                + ", intent=" + intent + ", getSrcMacNodeId()="
                + getSrcMacNodeId() + ", getDestMacNodeId()="
                + getDestMacNodeId() + ", getIngressNodeId()="
                + getIngressNodeId() + ", getEgressNodeId()="
                + getEgressNodeId() + ", hashCode()=" + hashCode()
                + ", getIntent()=" + getIntent() + "]";
    }
