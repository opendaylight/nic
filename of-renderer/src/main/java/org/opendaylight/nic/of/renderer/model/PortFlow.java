...
public class PortFlow {
    ...
    private interface MatchBuilderCreatorByPort {
        MatchBuilder create(final PortNumber portNumber);
    }
    ...
    public PortFlow(final Integer maxPortNumber,
                    final Integer minPortNumber,
                    final String protocolType,
                    final String ethernetType,
    ...
    public Set<MatchBuilder> createPortRangeMatchBuilder() {
        final MatchBuilderCreator matchBuilderCreator = matchBuilderCreatorMap.get(protocolType);
        return matchBuilderCreator.create();
    }

    private MatchBuilder getIpv6MatchBuilder() {
        final MatchBuilder matchBuilder = getIcmpMatchBuilder();
    ...
    private String createPortFlowName(final PortNumber portNumber) {
    ...
    public String createFlowName(String intentId) {
        ...
        portName += IntentProtocolType.ProtocolIcmp.equals(protocolType) ?
                createICMPFlowName() : createPortFlowName(new PortNumber(minPortNumber));
        return portName;
    }
