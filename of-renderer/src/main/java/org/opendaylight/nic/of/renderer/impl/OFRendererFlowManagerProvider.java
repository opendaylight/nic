...
public class OFRendererFlowManagerProvider implements OFRendererFlowService, AutoCloseable {
    ...
    public void pushIntentFlow(Intent intent, FlowAction flowAction) {
        ...
        Map<String, Map<String, String>> subjectsMapping = extractSubjectDetails(endPointGroups, intentMappingService);
    ...
    public static Map<String, Map<String, String>> extractSubjectDetails(List<String> endPointGroups,
