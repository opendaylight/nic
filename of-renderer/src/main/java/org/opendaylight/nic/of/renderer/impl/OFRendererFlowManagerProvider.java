...
public class OFRendererFlowManagerProvider implements OFRendererFlowService, Observer, AutoCloseable , IntentTransactionListener {
    ...
    public void init() {
        ...
        ServiceReference<?> serviceReferenceRegister = context
        ...
        transactionRegistryService = (IntentTransactionRegistryService) context
                .getService(serviceReferenceRegister);
        transactionRegistryService.registerForExecutor(this);

        this.transactionNotifier = (IntentTransactionNotifier) context.getService(serviceReferenceNotifier);
    }
