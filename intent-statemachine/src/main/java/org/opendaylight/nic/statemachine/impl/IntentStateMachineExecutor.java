...
public class IntentStateMachineExecutor implements IntentStateMachineExecutorService, IntentTransactionResultListener {
    ...
    public void init() {
        ...
        ServiceReference<?> commonProviderServiceReference = context
        ...
        commonProviderService = (IntentCommonProviderService) context.getService(commonProviderServiceReference);

        commonProviderService.registerForResults(this);
    }
