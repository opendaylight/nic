...
import org.opendaylight.nic.statemachine.engine.service.DisableService;
import org.opendaylight.nic.statemachine.engine.service.StateMachineRendererService;
import org.opendaylight.nic.statemachine.impl.StateMachineException;
...
public class DisableServiceImpl implements DisableService {
    ...
    @Override
    public void onError(String message) throws StateMachineException {
        LOG.error(message);
