...
public class IntentTransactionNotifierImpl implements IntentTransactionNotifier {
    ...
    protected static ServiceRegistration<IntentTransactionNotifier> nicEventServiceRegistration;
    ...
    public static void init() {
        ...
        if(transactionNotifier == null) {
            ...
            BundleContext bundleContext = FrameworkUtil.getBundle(transactionNotifier.getClass()).getBundleContext();
            nicEventServiceRegistration = bundleContext.registerService(IntentTransactionNotifier.class, transactionNotifier, null);
