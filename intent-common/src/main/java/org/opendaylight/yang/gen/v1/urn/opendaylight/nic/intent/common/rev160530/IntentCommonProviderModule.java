...
public class IntentCommonProviderModule extends org.opendaylight.yang.gen.v1.urn.opendaylight.nic.intent.common.rev160530.AbstractIntentCommonProviderModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        ServiceReference<?> intentStateMachineReference = context.getServiceReference(IntentStateMachineExecutorService.class);
        IntentStateMachineExecutorService stateMachineExecutorService = (IntentStateMachineExecutorService) context.getService(intentStateMachineReference);

        final IntentCommonProviderService commonProvider = new IntentCommonProviderServiceImpl(getDataBrokerDependency(),
                ofRendererFlowService, stateMachineExecutorService);
