...
public class ScheduleServiceManager implements ScheduleService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ScheduleServiceManager.class);
    ...
    private class Executor extends TimerTask {
        ...
        @Override
        public void run() {
            LOG.info("\n### Running scheduled action. Dataflow {} - RendererService {}", dataflow.toString(), rendererService.toString());
