...
public class GBPTenantPolicyCreator {
    ...
    public GBPTenantPolicyCreator(DataBroker dataBroker,
        ...
        providerL3Addresses = new ArrayList<>();
        consumerL3Addresses = new ArrayList<>();
    ...
    private Boolean getTenantEndpointAttributes(String subjectId, Boolean provider){
        ...
        for(Endpoint e: matchingEndpoints){
            ...
            List<L3Address> l3Addresses = e.getL3Address();

            for(L3Address address : l3Addresses){
                LOG.info(String.format("%s address: %s"
        ...
        LOG.info(String.format("L3 Address for %s: %d"
                , subjectId
    ...
    private List<Endpoint> readEPNodes(String subjectId){
        ...
        if (node != null) {
            ...
            LOG.error(String.format("Endpoints not found for the path %s", nodePath));
        }
    ...
    /***
     * Pushes endpoint into the configuration data store
     * @param tenant
     */
