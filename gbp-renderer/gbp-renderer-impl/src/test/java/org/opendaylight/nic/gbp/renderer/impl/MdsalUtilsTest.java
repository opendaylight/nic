 ...
 */
 public class MdsalUtilsTest {
    ...
    public void testDelete()throws Exception {
        final LogicalDatastoreType[] logicalDatastoreType = LogicalDatastoreType.values();
        final InstanceIdentifier instanceIdentifier = mock(InstanceIdentifier.class);
        /**
         ...
         */
        assertTrue(mdsalUtils.delete(logicalDatastoreType[0], instanceIdentifier));
        verify(writeTransaction).delete(logicalDatastoreType[0], instanceIdentifier);
        ...
        assertFalse(mdsalUtils.delete(logicalDatastoreType[0], instanceIdentifier));
        verify(writeTransaction, times(2)).delete(logicalDatastoreType[0], instanceIdentifier);
    ...
    public void testMerge()throws Exception {
         ...
         */
        assertTrue(mdsalUtils.merge(logicalDatastoreType[0], instanceIdentifier, dataObject));
        verify(writeTransaction).merge(logicalDatastoreType[0], instanceIdentifier, dataObject, true);
        verify(writeTransaction).submit();
        /**
         ...
         */
        when(checkedFuture.checkedGet()).thenThrow(TransactionCommitFailedException.class);
        assertFalse(mdsalUtils.merge(logicalDatastoreType[0], instanceIdentifier, dataObject));
        verify(writeTransaction, times(2)).merge(logicalDatastoreType[0], instanceIdentifier, dataObject, true);
        verify(writeTransaction, times(2)).submit();
    }
    ...
    public void testPut() throws Exception {
         ...
         */
        assertTrue(mdsalUtils.put(logicalDatastoreType[0], instanceIdentifier, dataObject));
        verify(writeTransaction).put(logicalDatastoreType[0], instanceIdentifier, dataObject, true);
        verify(writeTransaction).submit();
        /**
         ...
         */
        when(checkedFuture.checkedGet()).thenThrow(TransactionCommitFailedException.class);
        assertFalse(mdsalUtils.put(logicalDatastoreType[0], instanceIdentifier, dataObject));
        verify(writeTransaction, times(2)).put(logicalDatastoreType[0], instanceIdentifier, dataObject, true);
        verify(writeTransaction, times(2)).submit();
    }
    ...
    public void testRead() throws Exception {
        ...
        final InstanceIdentifier<DataObject> instanceIdentifier = mock(InstanceIdentifier.class);
        when(checkedFuture.checkedGet()).thenReturn(optional);
        when(readOnlyTransaction.read(logicalDatastoreType[0], instanceIdentifier)).thenReturn(checkedFuture);
        /**
         ...
         */
        assertNull(mdsalUtils.read(logicalDatastoreType[0], instanceIdentifier));
        when(optional.isPresent()).thenReturn(true);
        when(optional.get()).thenReturn(mock(DataObject.class));
        verify(readOnlyTransaction).read(logicalDatastoreType[0], instanceIdentifier);
         ...
         */
        assertTrue(mdsalUtils.read(logicalDatastoreType[0], instanceIdentifier) instanceof DataObject);
        verify(readOnlyTransaction, times(2)).read(logicalDatastoreType[0], instanceIdentifier);
        ...
        assertNull(mdsalUtils.read(logicalDatastoreType[0], instanceIdentifier));
        verify(readOnlyTransaction, times(3)).read(logicalDatastoreType[0], instanceIdentifier);
