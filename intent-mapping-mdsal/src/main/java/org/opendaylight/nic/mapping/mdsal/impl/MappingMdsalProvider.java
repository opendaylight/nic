...
public class MappingMdsalProvider implements IntentMappingService,
    ...
    public void add(String key, Map<String, String> objs) {
        ...
        // We want the Op store to be in sync with the Config store
        mdsalUtils.merge(LogicalDatastoreType.OPERATIONAL, outerMapIid, outerMap);
    }
    ...
    public Map<String, String> get(String key) {
        ...
        listInnerMap = mdsalUtils.read(LogicalDatastoreType.OPERATIONAL, outerMapIid).getInnerMap();
