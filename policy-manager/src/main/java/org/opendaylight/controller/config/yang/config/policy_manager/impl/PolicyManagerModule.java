...
public class PolicyManagerModule
        extends
        org.opendaylight.controller.config.yang.config.policy_manager.impl.AbstractPolicyManagerModule
        implements java.lang.AutoCloseable {

    private static final Logger log = LoggerFactory
            .getLogger(PolicyManagerModule.class);
    ...
    public PolicyManagerModule(
            org.opendaylight.controller.config.api.ModuleIdentifier identifier,
            org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,
            org.opendaylight.controller.config.yang.config.policy_manager.impl.PolicyManagerModule oldModule,
    ...
    public java.lang.AutoCloseable createInstance() {
        validator = new PolicyValidator(getDataBrokerDependency(),
                getRpcRegistryDependency(), getNotificationServiceDependency());
