...
/**
 * Interface for accepting notification about various application events
 */
public interface IEventListener {
    /**
     * Issues notification about an application event.
     *
     * @param event Application event type.
     * @param app   Application object that the event applies to.
     */
