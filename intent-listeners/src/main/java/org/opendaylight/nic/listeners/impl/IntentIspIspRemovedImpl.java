 ...
 */
public class IntentIspIspRemovedImpl implements IntentIspPrefixRemoved {

    private IntentIspPrefix intentIspPrefix;
    private final Timestamp timestamp;

    public IntentIspIspRemovedImpl(final IntentIspPrefix intentIsp) {
        this.intentIspPrefix = intentIsp;
        Date date = new Date();
