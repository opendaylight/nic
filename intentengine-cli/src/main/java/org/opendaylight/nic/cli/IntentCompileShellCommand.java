...
@Command(name = "compile", scope = "intent", description = "Compile all intents and provide the results after conflict resolution")
public class IntentCompileShellCommand extends OsgiCommandSupport {
    ...
    protected Object doExecute() throws Exception {
        // calling the compile method on the NicProvider
