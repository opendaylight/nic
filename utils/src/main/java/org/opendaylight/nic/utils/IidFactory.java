...
public class IidFactory {
    ...
    /**
     * Creates a Topology {@link InstanceIdentifier} for OpenFlow Network-Topology.
     * @return instanceIdentifier of the OF Network-Topology
     */
    public static InstanceIdentifier<Topology> getTopologyLinkInstanceIdentifier() {
