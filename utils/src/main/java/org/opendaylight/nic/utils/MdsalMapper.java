...
public class MdsalMapper {
     ...
     */
    public InstanceIdentifier<Node> getNodeWildII() {
     ...
     */
    public InstanceIdentifier<Node> getNodeII(final InstanceIdentifier<?> ii) {
     ...
     */
    public NodeRef createNodeRef(InstanceIdentifier<?> path) {
     ...
     */
    public InstanceIdentifier<Link> getLinkWildII() {
     ...
     */
    public InstanceIdentifier<Link> getLinkII(final InstanceIdentifier<?> path) {
