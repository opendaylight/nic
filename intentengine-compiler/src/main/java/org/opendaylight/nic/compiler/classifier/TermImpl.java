...
import org.opendaylight.nic.compiler.IntervalImpl;
...
/**
 * TermImpl is used as a building block to create {@link ExpressionImpl}s. It
 * consists of {@link TermLabel} and a set of {@link Intervals. The Intervals
 * can be thought of as logically OR'd together to make the Term.
 */
